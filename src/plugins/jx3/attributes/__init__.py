...
jx3_cmd_addritube = on_command("jx3_addritube", aliases={"属性v1", "查装v1"}, force_whitespace=True, priority=5)
...
jx3_cmd_addritube_v2 = on_command("jx3_addritube_v2", aliases={"属性", "查装", "属性v2", "查装v2"}, force_whitespace=True, priority=5)
...
jx3_cmd_roleInfo = on_command("jx3_player", aliases={"玩家信息"}, force_whitespace=True, priority=5)
