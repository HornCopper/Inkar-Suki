...
function FormRecorder(key, defaultItem) {
...
function toQueryStartEndByArray (datetime) {
...
function toQueryValue(value, build_object_event_is_null) {
...
function toQueryStartEnd(start, end) {
  return toQueryStartEndByArray([start, end])
}

function toQueryArrays(arr) {
  if (!arr) return null
  return {
