...
function getColorByPercentage(percent, red = default_red, green = default_green) {
  percent = percent / 100
 ...
 * @return {*}
 */
function distinct(array, idFunc) {
 ...
 * @return {*}
 */
function arrayToBinaryFlag(array) {
 ...
 * @param {*} parentIdFunc
 */
function arrayToTree(array, idFunc, parentIdFunc) {
