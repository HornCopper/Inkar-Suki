...
with open(
    build_path(ASSETS, ["source", "jx3", "dungeon_name.json"]),
    encoding="utf-8",
    mode="r",
) as dungeon_name:
...
with open(
    build_path(ASSETS, ["source", "jx3", "dungeon_mode.json"]),
    encoding="utf-8",
    mode="r",
) as dungeon_mode:
...
with open(
    build_path(ASSETS, ["source", "jx3", "kungfu_aliases.json"]),
    encoding="utf-8",
    mode="r",
) as kungfu_aliases:
...
with open(
    build_path(ASSETS, ["source", "jx3", "kungfu_colors.json"]),
    encoding="utf-8",
    mode="r",
) as kungfu_colors:
...
with open(
    build_path(ASSETS, ["source", "jx3", "kungfu_internel_id.json"]),
    encoding="utf-8",
    mode="r",
) as kungfu_internel_id:
    kungfu_internel_id_data = json.loads(kungfu_internel_id.read())

with open(
    build_path(ASSETS, ["source", "jx3", "kungfu_basic.json"]),
    encoding="utf-8",
    mode="r",
) as kungfu_basic:
...
with open(
    build_path(ASSETS, ["source", "jx3", "kungfu_coefficient.json"]),
    encoding="utf-8",
    mode="r",
) as kungfu_coefficient:
    kungfu_coefficient_data = json.loads(kungfu_coefficient.read())

with open(
    build_path(ASSETS, ["source", "jx3", "kungfu_baseattr.json"]),
    encoding="utf-8",
    mode="r",
) as kungfu_baseattr:
...
with open(
    build_path(ASSETS, ["source", "jx3", "school_aliases.json"]),
    encoding="utf-8",
    mode="r",
) as school_aliases:
...
with open(
    build_path(ASSETS, ["source", "jx3", "school_internel_id.json"]),
    encoding="utf-8",
    mode="r",
) as school_internel_id:
    school_internel_id_data = json.loads(school_internel_id.read())

with open(
    build_path(ASSETS, ["source", "jx3", "school_snacks.json"]),
    encoding="utf-8",
    mode="r",
) as school_snacks:
...
with open(
    build_path(ASSETS, ["source", "jx3", "server_aliases.json"]),
    encoding="utf-8",
    mode="r",
) as server_aliases:
